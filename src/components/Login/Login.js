...
<button className='btn btn-primary w-full text-white capitalize tracking-[1px] ' type='submit'>Login </button>
            <p className='mt-2 text-[14px] capitalize text-[#686687] font-bold'>Need an account ? <Link to="/register" className='text-primary'> Register</Link></p>
            <p className='mt-2 text-[14px] capitalize text-[#686687] font-bold'>forget password?</p>
            <div className='absolute bottom-[20px]'>
              <div className='flex justify-around text-[14px] capitalize text-[#686687] font-bold'>
